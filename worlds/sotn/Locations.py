...
def get_location_datas(world: Optional[MultiWorld], player: Optional[int]) -> List[LocationData]:
    ...
    locations: List[LocationData] = [
        ...
        LocationData('Castle Entrance', 'Castle Entrance: Power of Wolf', 135032),
        ...
        LocationData('Long Library', 'Long Library: Faerie Card', 135014, logic.has_some_upward_mobility),
        ...
        LocationData('Abandoned Mine', 'Abandoned Mine: Cerberos', 135027, logic.access_catacombs),
        LocationData('Catacombs', 'Catacombs: Granfaloon', 135028, logic.access_catacombs),
        ...
        LocationData('Olrox\'s Quarters', 'Olrox\'s Quarters: Echo of Bat', 135030, logic.can_fly),
        ...
        LocationData('Colosseum', 'Colosseum: Minotaur', 135034, logic.can_double_jump),
        ...
        LocationData('Black Marble Gallery', 'Black Marble Gallery: Shaft', 140013, lambda state: logic.can_save_richter(state) and logic.all_vlad(state)),
