...
def create_regions_and_locations(world: MultiWorld, player: int):
    ...
    connect_regions(world, player, 'Marble Gallery', 'Olrox\'s Quarters'),
    connect_regions(world, player, 'Marble Gallery', 'Underground Caverns'),
    ...
    connect_regions(world, player, 'Royal Chapel', 'Alchemy Laboratory'),
    connect_regions(world, player, 'Royal Chapel', 'Castle Keep'),
    connect_regions(world, player, 'Underground Caverns', 'Marble Gallery'),
    connect_regions(world, player, 'Underground Caverns', 'Abandoned Mine'),
    ...
    connect_regions(world, player, 'Clock Tower', 'Castle Keep'),
    ...
    connect_regions(world, player, 'Castle Keep', 'Clock Tower'),
